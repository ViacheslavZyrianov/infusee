...
<template>
  <v-container class="pb-16">
    ...
    <p>
      ...
      <a href="#">Privacy Policy</a>. If you do not agree to these Terms, do not use our Services.
    </p>

    <h2>1. Use of Our Services</h2>
    <p>
      You may use our Services only if you are legally able to form a binding contract. You must
      comply with all applicable laws and these Terms.
    </p>

    <h2>2. Google Services and Branding</h2>
    <p>Some features of our Services may incorporate or interact with Google services, such as:</p>
    <ul>
      <li>Google Maps</li>
    ...
    <p>
      These services are provided by Google and are subject to Google’s own terms and policies. By
      using our Services, you also agree to comply with:
    </p>
    <ul>
      <li>
    ...
    <p>
      ...
      maintaining the confidentiality of your account and for all activities that occur under it.
    </p>
    ...
    <ul>
      ...
      <li>Use automated tools to access the Services without prior written permission</li>
    </ul>
    ...
    <h2>6. Termination</h2>
    <p>
      We reserve the right to suspend or terminate your access to the Services at any time for any
      reason without notice.
    </p>

    <h2>7. Disclaimers and Limitation of Liability</h2>
    <p>
      Our Services are provided "as is" and "as available." We do not make any warranties regarding
      the availability, reliability, or accuracy of the Services.
    </p>
    ...
    <p>
      ...
      this page. Continued use of the Services after changes constitutes your acceptance of the
      updated Terms.
    </p>

    <h2>9. Contact Us</h2>
    <p>If you have any questions about these Terms, you can contact us via email at:</p>
    <p>
      <a href="mailto:zyrianov.viacheslav@gmail.com"> zyrianov.viacheslav@gmail.com </a>
    </p>
  </v-container>
