...
<template>
  <v-container class="pb-16">
    ...
    <ul>
      <li>
        <strong>Personal Information:</strong> Such as your name, email address, or any other
        information you provide when signing up or contacting us.
      </li>
      <li>
        <strong>Usage Data:</strong> Includes your IP address, browser type, pages visited, time and
        date of visit, and other technical data collected through cookies or analytics tools.
      </li>
      <li>
        <strong>Device Information:</strong> Data about the device you use to access our service
        (e.g., mobile, desktop, operating system).
      </li>
    </ul>
    ...
    <p>
      We do <strong>not</strong> sell, rent, or trade your personal information. We may share your
      information with:
    </p>
    <ul>
      <li>
        <strong>Service Providers:</strong> Third-party vendors that help us manage operations
        (e.g., hosting, analytics)
      </li>
      <li>
        <strong>Legal Authorities:</strong> When required to comply with applicable laws or valid
        legal processes
      </li>
    ...
    <p>
      ...
      traffic, and understand user behavior. You can manage cookie preferences through your browser
      settings.
    </p>
    ...
    <p>
      ...
      However, no internet-based service is entirely secure, and we cannot guarantee absolute
      security.
    </p>
    ...
    <p>To exercise any of these rights, contact us using the information provided below.</p>
  ...
  <v-footer class="position-fixed bottom-0 right-0 left-0 flex justify-center">
    <v-btn href="/terms-of-service" variant="text" class="text-decoration-underline">
      Terms Of Service
    </v-btn>
